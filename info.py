...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1001602841052').split()]  # For Multiple Id Use One Space Between Each.
