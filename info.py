...
# Bot information
SESSION = environ.get('SESSION', 'ThorAutoFilter2bot')
...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '6667067260 1799623305 6017903256').split()]  # For Multiple Id Use One Space Between Each.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/ThorRequest')
