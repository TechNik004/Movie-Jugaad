...
# Bot information
SESSION = environ.get('SESSION', 'MovieJugaadbot')
...
PICS = (environ.get('PICS', 'https://envs.sh/mN.jpg')).split()
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002524577917'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002583861689').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002709753158') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', '-1002871361716')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002617272650')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None

# This Channel Is For /batch command file store.
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002583861689')).split()]  # For Multiple Id Use One Space Between Each.
...
DATABASE_NAME = environ.get('DATABASE_NAME', "PG")
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/MovieJugaad_Request')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/MovieJugaadX')
