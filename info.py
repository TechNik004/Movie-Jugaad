...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002372316135']  # For Multiple Id Use One Space Between Each.
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://likely-aggy-trexowner-fcc6d765.koyeb.app/")
